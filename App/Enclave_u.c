...
sgx_status_t ecall_read(sgx_enclave_id_t eid, unsigned long int* va)
{
	sgx_status_t status;
	ms_ecall_read_t ms;
	ms.ms_va = va;
...
sgx_status_t ecall_tcs(sgx_enclave_id_t eid, unsigned long int* tcs)
{
	sgx_status_t status;
	ms_ecall_tcs_t ms;
	ms.ms_tcs = tcs;
...
sgx_status_t ecall_aep(sgx_enclave_id_t eid, unsigned long int* aep)
{
	sgx_status_t status;
	ms_ecall_aep_t ms;
	ms.ms_aep = aep;
...
sgx_status_t ecall_reg(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t ecall_write(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t ecall_write2(sgx_enclave_id_t eid, unsigned long int* va)
{
	sgx_status_t status;
	ms_ecall_write2_t ms;
	ms.ms_va = va;
	status = sgx_ecall(eid, 5, &ocall_table_Enclave, &ms);
	return status;
}

sgx_status_t ecall_write3(sgx_enclave_id_t eid)
{
	sgx_status_t status;
